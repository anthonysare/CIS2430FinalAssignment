...
public class MyConnection {
	 ...
	 * @param code The univ.Calendar.Course code
	...
	/**
	 * Saves information to the database. Accepts a database.DBStudent object only. See the database.DBStudent class for details
	 * on creating the database.DBStudent object.
	 * 
	 * @param s A database.DBStudent object. Its contents will be saved to the database.
	 */
	public void saveStudent(DBStudent s){
		System.out.println("Saving database.DBStudent object");
		String id = s.getId();
	...
	/**
	 * Loads and returns a database.DBStudent object, containing any available information.
	 * 
	 * @param id The student's id
	 * @param name The student's name
	 * @return database.DBStudent object which contains the student id, name, degree and course information.
	 */
	...
	/**
	 * NOT FOR GENERAL USE. Completely deletes all univ.Calendar.Course information from the database.
	 * 
	 */
