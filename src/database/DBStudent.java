...
public class DBStudent {
    ...
    /**
     * Suggested constructor for your database.DBStudent object. Stores student information in the format used by the database.
     * univ.Student.Student id and student name should never be empty!
     * 
