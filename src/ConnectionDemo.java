...
import database.PrepStudentScript;
...
public class ConnectionDemo {
	...
	/**
	 * Here you can see example usage of the database.MyConnection class. Be sure to fullyResetTables at least once after downloading and
	...
	public void testConnection(){
		...
		//clear all database.DBStudent information so we have a fresh db
